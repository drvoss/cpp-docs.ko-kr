...
개발자는 Visual C++의 사용법을 익히고 일상적인 작업에서 Visual C++ 사용에 참고하기 위해 문서의 내용을 확인합니다.
...
### <a name="write-in-2nd-person"></a>2인칭 시점으로 작성
#### <a name="appropriate-style"></a>적절한 스타일:
...
### <a name="target-a-5th-grade-reading-level"></a>5등급 독자 수준을 대상으로 지정
