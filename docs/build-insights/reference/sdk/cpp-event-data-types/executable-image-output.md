...
[Fileoutput](file-output.md) 기본 클래스의 상속 된 멤버와 함께 `ExecutableImageOutput` 클래스에는 다음 멤버가 포함 됩니다.
