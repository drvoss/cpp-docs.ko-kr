---
title: Function 클래스
description: C++ BUILD Insights SDK 함수 클래스 참조입니다.
ms.date: 02/12/2020
helpviewer_keywords:
- C++ Build Insights
...
[작업](activity.md) 기본 클래스의 상속 된 멤버와 함께 `Function` 클래스에는 다음 멤버가 포함 됩니다.
