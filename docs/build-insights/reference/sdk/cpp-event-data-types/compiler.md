---
title: 컴파일러 클래스
description: C++ BUILD Insights SDK 컴파일러 클래스 참조입니다.
ms.date: 02/12/2020
helpviewer_keywords:
- C++ Build Insights
...
[호출](invocation.md) 기본 클래스의 상속 된 멤버와 함께 `Compiler` 클래스에는 다음 멤버가 포함 됩니다.

### <a name="constructors"></a>생성자

[컴파일러나](#compiler)

## <a name="compiler"></a>컴파일러나
