---
title: 스타트트레이싱세션W
description: C ++ 빌드 인사이트 SDK 스타트레이싱SessionW 함수 참조.
ms.date: 02/12/2020
helpviewer_keywords:
- C++ Build Insights
...
ms.locfileid: "81323788"
---
# <a name="starttracingsessionw"></a>스타트트레이싱세션W
...
함수가 `StartTracingSessionW` 추적 세션을 시작합니다. 이 함수를 호출하는 실행 에는 관리자 권한이 있어야 합니다.
...
*세션 이름*\
시작할 추적 세션의 이름입니다. [StopTracingSessionW](stop-tracing-session-w.md)또는 다른 중지 추적 함수를 호출할 때 동일한 이름을 사용합니다.
