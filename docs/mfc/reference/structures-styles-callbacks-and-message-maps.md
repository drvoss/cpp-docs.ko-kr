...
[MFC에서 사용하는 구조체](../../mfc/reference/structures-used-by-mfc.md)<br/>
다양한 멤버 함수에서 호출되는 구조체에 대한 링크를 제공합니다.

[MFC에서 사용하는 스타일](../../mfc/reference/styles-used-by-mfc.md)<br/>
MFC 개체를 만들 때 사용하는 스타일에 대한 링크를 제공합니다.

[MFC에서 사용하는 콜백 함수](../../mfc/reference/callback-functions-used-by-mfc.md)<br/>
