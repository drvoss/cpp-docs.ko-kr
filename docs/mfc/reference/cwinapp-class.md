...
|*pRecoveryCallback*|진행 복구 콜백 함수입니다. 이 함수는 LPVOID 매개 변수를 입력으로 사용 하 고 DWORD를 반환 해야 합니다. 기본 복구 콜백 함수는 `CWinApp::ApplicationRecoveryCallback` 입니다.|
