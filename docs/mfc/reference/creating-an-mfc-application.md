...
- [폼 기반 MFC 애플리케이션 만들기](../../mfc/reference/creating-a-forms-based-mfc-application.md)

- [파일 탐색기 스타일 MFC 애플리케이션 만들기](../../mfc/reference/creating-a-file-explorer-style-mfc-application.md)

- [웹 브라우저 스타일 MFC 애플리케이션 만들기](../../mfc/reference/creating-a-web-browser-style-mfc-application.md)
...
![MFC 응용 프로그램 마법사](media/mfc-app-wizard.png)
...
![MFC 응용 프로그램 마법사](media/windows-desktop-wizard.png)
...
1. 주 메뉴에서 **파일** > **새** > **프로젝트**를 선택 합니다.
1. **설치** 된 템플릿에서 **Visual C++**  > **MFC/ATL**을 선택 합니다. 표시되지 않는 경우 Visual Studio 설치 관리자를 사용하여 추가합니다.
...
1. 주 메뉴에서 **파일** > **새** > **프로젝트**를 선택 합니다.
1. **설치** 된 템플릿에서  **C++ Visual** > **Windows Desktop**을 선택 합니다.
1. 가운데 창에서 **Windows 바탕 화면 마법사** 를 선택 합니다.
1. 필요에 따라 프로젝트 이름을 수정한 다음 **확인** 을 눌러 **Windows 바탕 화면 마법사**를 엽니다.
1. **MFC 헤더** 상자를 확인 하 고 필요에 따라 다른 값을 설정한 후 **마침**을 누릅니다.

![MFC 응용 프로그램 마법사](media/windows-desktop-wizard-2017.png)
...
![MFC 응용 프로그램 마법사](media/mfc-app-wizard-2015.png)
