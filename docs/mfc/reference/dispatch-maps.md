...
프로그램의 `CCmdTarget`파생 클래스가 OLE 자동화를 지 원하는 경우 해당 클래스는 해당 메서드 및 속성을 노출 하는 디스패치 맵을 제공 해야 합니다.
...
> [!NOTE]
> DECLARE_DISPATCH_MAP 후 멤버를 선언 하는 경우 해당 멤버에 대 한 새 액세스 형식 ( **public**, **private**또는 **protected**)을 지정 해야 합니다.
