...
MFC 라이브러리는 Microsoft Windows의 프로그래밍에 대한 애플리케이션 프레임워크입니다. C++로 작성된 경우 MFC는 창, 메뉴 및 대화 상자 관리, 기본 입력/출력 수행, 데이터 개체의 컬렉션 저장 등에 대해 필요한 코드를 제공합니다. 이 프레임워크에 애플리케이션별 코드를 추가하기만 하면 됩니다. C + + 클래스 프로그래밍의 특성을 고려 하 여 [MFC 프레임 워크에서](framework-mfc.md) 제공 하는 기본 기능을 확장 하거나 재정의 하는 것이 쉽습니다.
...
MFC 참조 설명서에 대 한 개요는 [MFC 라이브러리](mfc-desktop-applications.md)를 참조 하세요.
