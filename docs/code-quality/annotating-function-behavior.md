...
ms.locfileid: "79467062"
---
# <a name="annotating-function-behavior"></a>함수 동작에 주석 달기
...
|`_Use_decl_annotations_`|는 헤더의 주석 목록 대신 함수 정의 (함수 본문이 라고도 함)에 사용할 수 있습니다.  `_Use_decl_annotations_`를 사용 하는 경우 동일한 함수의 범위 내 헤더에 표시 되는 주석은 `_Use_decl_annotations_` 주석이 있는 정의에도 있는 것 처럼 사용 됩니다.|
