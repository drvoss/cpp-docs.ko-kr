...
|||
|-|-|
|[가 나 Advise](#atladvise)|개체의 연결 지점과 클라이언트의 싱크 간에 연결을 만듭니다.|
|[AtlUnadvise](#atlunadvise)|`AtlAdvise`를 통해 설정 된 연결을 종료 합니다.|
...
*pUnkCP*<br/>
진행 클라이언트에서 연결 하려는 개체의 `IUnknown`에 대 한 포인터입니다.

*pUnk*<br/>
진행 클라이언트의 `IUnknown`에 대 한 포인터입니다.
...
*pUnkCP*<br/>
진행 클라이언트와 연결 된 개체의 `IUnknown`에 대 한 포인터입니다.
