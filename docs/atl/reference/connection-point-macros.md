...
맵의 연결 지점 항목은 [IConnectionPointContainerImpl](../../atl/reference/iconnectionpointcontainerimpl-class.md)에서 사용 됩니다. 연결 지점 맵을 포함 하는 클래스는 `IConnectionPointContainerImpl`에서 상속 되어야 합니다.
