...
속성 맵은 속성 설명, 속성 Dispid, 속성 페이지 Clsid 및 `IDispatch` Iid를 저장 합니다. [IPerPropertyBrowsingImpl](../../atl/reference/iperpropertybrowsingimpl-class.md), [IPersistPropertyBagImpl](../../atl/reference/ipersistpropertybagimpl-class.md), [IPersistStreamInitImpl](../../atl/reference/ipersiststreaminitimpl-class.md)및 [ISpecifyPropertyPagesImpl](../../atl/reference/ispecifypropertypagesimpl-class.md) 클래스는 속성 맵을 사용 하 여이 정보를 검색 하 고 설정 합니다.
...
*member*<br/>
진행 익스텐트를 포함 하는 데이터 멤버입니다. 예를 들어 `m_sizeExtent`합니다.
...
다음 예제에서는 개체의 범위 (`m_sizeExtent`)를 유지 하 고 있습니다.
...
다음 예에서는 `IMyDual1`에 대 한 항목을 그룹화 한 후 `IMyDual2`항목을 그룹화 합니다. 이중 인터페이스를 기준으로 그룹화 하면 성능이 향상 됩니다.
