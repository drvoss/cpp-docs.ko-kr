...
|[SetExternalUIHandler](#setexternaluihandler)|개체에서 사용 하는 외부 인터페이스를 설정 `IDocHostUIHandler` `CAxWindow` 합니다.|
...
`CAxWindow`기존 창 개체 핸들을 사용 하 여 개체를 생성 합니다.
