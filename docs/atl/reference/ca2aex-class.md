...
ms.locfileid: "81319177"
---
# <a name="ca2aex-class"></a>CA2AEX 클래스

이 클래스는 문자열 변환 매크로 CA2TEX 및 CT2AEX 및 형식 DEF CA2A에서 사용됩니다.
...
|속성|Description|
|----------|-----------------|
|[CA2AEX::연산자 LPSTR](#operator_lpstr)|변환 연산자.|

### <a name="public-data-members"></a>공용 데이터 멤버

|속성|Description|
|----------|-----------------|
|[CA2AEX:m_psz](#m_psz)|원본 문자열을 저장하는 데이터 멤버입니다.|
|[CA2AEX:m_szBuffer](#m_szbuffer)|변환된 문자열을 저장하는 데 사용되는 정적 버퍼입니다.|

## <a name="remarks"></a>설명

추가 기능이 필요하지 않는 한 자체 코드에서 CA2TEX, CT2AEX 또는 CA2A를 사용합니다.
...
## <a name="ca2aexoperator-lpstr"></a><a name="operator_lpstr"></a>CA2AEX::연산자 LPSTR
