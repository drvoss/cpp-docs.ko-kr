...
ms.locfileid: "81331024"
---
# <a name="crtthreadtraits-class"></a>CRTThreadTraits 클래스

이 클래스는 CRT 스레드에 대한 만들기 함수를 제공합니다. 스레드에서 CRT 함수를 사용하는 경우 이 클래스를 사용합니다.
...
|속성|Description|
|----------|-----------------|
|[CRT스레드특성::만들기스레드](#createthread)|(정적) CRT 함수를 사용할 수 있는 스레드를 만들려면 이 함수를 호출합니다.|
...
스레드가 CRT 함수를 사용하지 않는 경우 [Win32ThreadTraits를](../../atl/reference/win32threadtraits-class.md) 대신 사용합니다.

## <a name="requirements"></a>요구 사항

**헤더:** atlbase.h

## <a name="crtthreadtraitscreatethread"></a><a name="createthread"></a>CRT스레드특성::만들기스레드
...
이 함수는 [스레드를](../../c-runtime-library/reference/beginthread-beginthreadex.md) 만드는 _beginthreadex 호출합니다.
