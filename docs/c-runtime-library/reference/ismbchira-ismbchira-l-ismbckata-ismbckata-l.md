...
|-------------|-------------------------------------------|
|**_ismbchira**|이중 바이트 히라가나: 0x829F<=*c*<=0x82F1.|
|**_ismbchira_l**|이중 바이트 히라가나: 0x829F<=*c*<=0x82F1.|
|**_ismbckata**|이중 바이트 카타카나: 0x8340<=*c*<=0x8396.|
|**_ismbckata_l**|이중 바이트 카타카나: 0x8340<=*c*<=0x8396.|
