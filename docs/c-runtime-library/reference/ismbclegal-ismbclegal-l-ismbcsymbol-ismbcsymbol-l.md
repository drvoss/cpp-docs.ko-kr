...
|-------------|--------------------|---------------------------|
|**_ismbclegal**|유효한 멀티바이트|*c의* 첫 번째 바이트가 0x81 - 0x9F 또는 0xE0 - 0xFC 범위 내에 있는 경우에만 비영도를 반환하고 두 번째 바이트는 범위 0x40 - 0x7E 또는 0x80 - FC 내에 있는 경우에만 반환합니다.|
|**_ismbcsymbol**|멀티바이트 기호|0x8141<=*c*<=0x81AC인 경우에만 비영도 반환합니다.|
