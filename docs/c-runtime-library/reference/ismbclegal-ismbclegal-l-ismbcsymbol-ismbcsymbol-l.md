...
|-------------|--------------------|---------------------------|
|**_ismbclegal**|유효한 멀티바이트|*C* 의 첫 번째 바이트가 0X81-0X9F 또는 0XE0-0xfc 범위 내에 있고 두 번째 바이트는 0X40-0x7e 또는 0X80-fc 범위 내에 있는 경우에만 0이 아닌 값을 반환 합니다.|
|**_ismbcsymbol**|멀티바이트 기호|는 0x8141<=*c*<= 0X8141 인 경우에만 0이 아닌 값을 반환 합니다.|
