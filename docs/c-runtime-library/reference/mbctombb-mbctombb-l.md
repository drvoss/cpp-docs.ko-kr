...
성공 하면 **_mbctombb** 와 **_mbctombb_l** *c*에 해당 하는 싱글바이트 문자를 반환 합니다. 그렇지 않으면 *c*를 반환 합니다.
...
이전 버전에서는 **_mbctombb** 를 **zentohan**라고 했습니다. 대신 **_mbctombb** 를 사용 해야 합니다.
