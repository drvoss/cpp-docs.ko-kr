...
ms.locfileid: "80171322"
---
# <a name="_access_s-_waccess_s"></a>_access_s, _waccess_s

파일 읽기/쓰기 권한을 결정합니다. [CRT의 보안 기능](access-waccess.md)에 설명된 대로 보안 기능이 향상된 [_access, _waccess](../../c-runtime-library/security-features-in-the-crt.md)의 버전입니다.
