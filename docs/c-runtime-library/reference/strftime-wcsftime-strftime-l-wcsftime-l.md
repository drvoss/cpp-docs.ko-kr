...
*크기*<br/>
*Strdest* 버퍼의 크기 이며 문자 (**char** 또는 **wchar_t**)로 측정 됩니다.
...
**_Strftime_l** 및 **_Wcsftime_l** 함수는 Microsoft 전용입니다. 호환성에 대한 자세한 내용은 [Compatibility](../../c-runtime-library/compatibility.md)을 참조하세요.
