...
**_Strtoui64** 함수는 *strsource* 를 **부호 없는** **__int64**변환 합니다. **_wcstoui64** 은 **_strtoui64**의 와이드 문자 버전입니다. *Strsource* 인수는 와이드 문자 문자열입니다. 그 외의 경우에는 이들 함수가 동일하게 동작합니다.
