...
<div id="main" class="v2">
                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <h3>Visual Studio 설치 및 C++ 작업 선택</h3>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container">
        ...
        <ul class="pivots">
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>C++를 사용하여 UWP(유니버설 Windows 플랫폼)용 앱을 개발할 수 있습니다.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>코드 작성</h3>
                                                    <p>코드 편집기를 사용하여 코드를 작성, 리팩터링, 탐색 및 이해합니다.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>빌드</h3>
                                                    <p>코드를 컴파일 및 연결하고 최대 처리량에 최적화합니다.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>성능 향상</h3>
                                                    <p>병목 상태를 식별하고 진단 도구를 사용하여 코드 성능을 최적화합니다.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>이식 및 업그레이드</h3>
                                                    <p>최신 버전의 Visual Studio로 업그레이드하고 레거시 앱을 최신 플랫폼으로 마이그레이션합니다.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <li>
                <a href="#langlib">언어 및 라이브러리</a>
                <ul id="langlib">
                    <li>
                        <a href="#langlib1">언어 및 라이브러리</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>표준 C/C++ 언어 및 라이브러리</h3>
                                                    <p>C/C++ 프로그래밍 언어 및 라이브러리의 Microsoft 구현입니다.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Windows 데스크톱 라이브러리</h3>
                                                    <p>MFC(Microsoft Foundation Class) 및 ATL(액티브 템플릿 라이브러리)</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>병렬 프로그래밍 라이브러리</h3>
                                                    <p>병렬 프로그래밍을 위한 Concrt, AMP 및 OpenMP 라이브러리입니다.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>유니버설 Windows 플랫폼 라이브러리</h3>
                                                    <p>WRL(Windows 런타임 C++ 템플릿 라이브러리)은 Windows 런타임 구성 요소를 만들고 사용하기 위한 간단한 방법을 제공하는 템플릿 라이브러리입니다.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
