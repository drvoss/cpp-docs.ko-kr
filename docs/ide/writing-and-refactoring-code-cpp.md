...
일부 기호는 결과 범위를 좁히기 위해 자동으로 생략됩니다. 예를 들어 클래스 외부에서 클래스 개체의 멤버에 액세스할 때 기본적으로 개인 멤버 또는 보호된 멤버(자식 클래스의 컨텍스트에 없는 경우)를 볼 수 없습니다. 하단의 단추를 사용하여 필터링을 조정할 수 있습니다.

드롭다운 목록에서 기호를 선택한 후 **탭**, **Enter**및 다른 커밋 문자 중 하나를 사용하거나 `{ } [ ] ( ) . , : ; + - * / % & | ^ ! = ? @ # \`다른 커밋 문자 중 하나를 사용하여 자동으로 완료할 수 있습니다(기본적으로:). 이 목록에서 문자를 추가 또는 제거하려면 **빠른 실행**(Ctrl + Q)에서 "IntelliSense"를 검색하고 **텍스트 편집기 > C/C++ > 고급** 옵션을 선택합니다. **멤버 목록 커밋 문자** 옵션을 사용하면 목록을 원하는 대로 변경하여 사용자 지정할 수 있습니다.
...
![C&#43;&#43; 인텔리코드](../ide/media/intellicode-cpp.png "C++ 인텔리코드")

::: moniker range="vs-2019"

Visual Studio 2019에서는 IntelliCode가 **C++ 데스크톱 개발** 워크로드의 선택적 구성 요소로 제공됩니다. IntelliCode가 C++에 대해 활성 상태인지 확인하려면 **도구** > **옵션** > **IntelliCode** > **일반으로** 이동하여 **C++ 기본 모델을** 사용 **설정으로**설정합니다.
...
**예측 IntelliSense를** 재정의하고 더 긴 목록을 표시하려면 **Ctrl + J를**누릅니다. **예측 IntelliSense가** 켜진 경우 **Ctrl + J를** 호출하면 예측 필터가 제거됩니다. **Ctrl + J**를 다시 누르면 관련된 멤버 목록 결과에서 내게 필요한 옵션 필터가 제거됩니다. IntelliSense 드롭다운 목록 아래의 ([+]) 버튼은 **Ctrl + J**. 단추 위로 마우스를 가져가면 표시되는 내용에 대한 도구 설명 정보가 표시됩니다.

![C&#43;&#43; 예측 인텔리센스](../ide/media/predictive-intellisense-cpp.png "예측 인텔리센스")
...
![C&#43;&#43; 템플릿 IntelliSense 표시 기존 인스턴스화](../ide/media/template-intellisense-cpp-1.png "템플릿 인텔리센스 표시 기존 인스턴스화")

T ** \<>** 아이콘을 클릭하여 **템플릿 표시줄을**확장/축소합니다. 연필 아이콘을 클릭하거나 **템플릿 표시줄**을 두 번 클릭하면 **편집** 창이 열립니다.

![C&#43;&#43; 템플릿 인텔리센스](../ide/media/template-intellisense-cpp-3.png "템플릿 IntelliSense")
...
![C&#43;&#43; 템플릿 인텔리센스 결과 목록](../ide/media/template-intellisense-cpp-2.png "템플릿 인텔리센스 결과 목록")

편집기 하단의 창은 각 인스턴스화가 발견된 위치 및 해당 인수를 보여줍니다.

![C&#43;&#43; 템플릿 인텔리센스 인스턴스화 맵](../ide/media/template-intellisense-cpp-4.png "템플릿 인텔리센스 인스턴스화 맵")
...
![C&#43;&#43; 변경 추적](../ide/media/change-tracking-cpp.png "변경 내용 추적")
...
![C&#43;&#43; 인서트 스니펫 드롭&#45;](../ide/media/vs2015_cpp_surround_with.png "vs2015_cpp_surround_with")

## <a name="add-class"></a>클래스 추가

**프로젝트** 메뉴 또는 **솔루션 탐색기**의 팝업 메뉴에서 새 클래스를 추가합니다.

![C&#43;&#43;새 클래스 추가](../ide/media/vs2017-add-class.png "vs2015_cpp_add_class")
...
다른 서식 옵션은 메인 메뉴의**고급** **편집** > 에서 찾을 수 있습니다.

![C++ 고급 편집 옵션](media/edit-advanced-cpp.png)

C++특정 편집 기능을 활성화하고 구성하기 위한 옵션은 **도구** > **옵션** > **텍스트 편집기** > **C/C++** 아래에 있습니다. 설정하려는 옵션을 선택한 후 대화 상자에 초점이 맞춰져 있을 때 **F1** 키를 누르면 추가 도움말을 확인할 수 있습니다. 일반적인 코드 서식 지정 옵션은 **빠른 실행**에 `Editor C++`을 입력합니다.

![비주얼 스튜디오 도구 > 옵션](../ide/media/tools-options.png "편집기 옵션")
