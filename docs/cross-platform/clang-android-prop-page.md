...
| Optimization | 애플리케이션의 최적화 수준을 지정합니다. | **사용자 지정** - 사용자 지정 최적화입니다.<br>**사용 안 함** - 최적화를 사용하지 않습니다.<br>**크기 최소화** - 크기에 맞게 최적화합니다.<br>**속도 최대화** - 속도에 맞게 최적화합니다.<br>**전체 최적화** - 고가의 최적화입니다.<br> |
