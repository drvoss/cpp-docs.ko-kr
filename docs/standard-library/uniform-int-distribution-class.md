...
클래스 템플릿은 모든 값이 동일하게 발생할 수 있도록 분포가 있는 사용자 지정 정수 형식의 값을 생성하는 포괄적인 분포를 설명합니다. 다음 테이블은 개별 멤버에 대한 문서와 연결되어 있습니다.
...
## <a name="uniform_int_distributionparam_type"></a><a name="param_type"></a>uniform_int_distribution::p아람_타입
