...
*args*\
unordered에 삽입할 요소를 생성하기 위해 전달되는 인수입니다.
...
*ValTy*\
Unordered_multimap에서 [value_type](../standard-library/map-class.md#value_type)요소를 생성 하는 데 사용할 수 있는 인수 형식을 지정 하 고 *Val* 을 인수로 사용 하는 템플릿 매개 변수입니다.
...
*오른쪽*\
에 `unordered_multimap` 복사 되는 `unordered_multimap` 입니다.
