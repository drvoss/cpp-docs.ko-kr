...
멤버 함수는 [unordered_multimap:: erase](#erase)`(` [unordered_multimap:: begin](#begin)`(),` [unordered_multimap:: end](#end)`())`를 호출 합니다.
...
Unordered_multimap의 기존 요소를 지운 후에 *는의 내용을* unordered_multimap 복사 하거나 이동 `operator=`.
