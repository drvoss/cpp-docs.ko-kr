---
title: lognormal_distribution 클래스
ms.date: 11/04/2016
f1_keywords:
...
ms.locfileid: "81351699"
---
# <a name="lognormal_distribution-class"></a>lognormal_distribution 클래스
...
클래스 템플릿은 사용자 지정 정수 형식의 값을 생성하는 분포를 설명하거나 로그 정규 분포에 따라 배포된 값이 제공되지 않으면 **double을** 입력합니다. 다음 테이블은 개별 멤버에 대한 문서와 연결되어 있습니다.
...
로그 정규 분포에 대한 자세한 내용은 Wolfram MathWorld 문서 [LogNormal Distribution](https://go.microsoft.com/fwlink/p/?linkid=400917)(로그 정규 분포)을 참조하세요.
...
## <a name="lognormal_distributionparam_type"></a><a name="param_type"></a>lognormal_distribution::p아람_타입
