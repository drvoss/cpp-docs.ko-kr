...
ms.locfileid: "79447569"
---
# <a name="value_compare-class"></a>value_compare 클래스
...
Hash_map에 포함 된 전체 요소의 `value_types` 간에 value_compare에서 제공 하는 비교 기준은 보조 클래스 생성에의 한 개별 요소의 키 간 비교에서 발생 합니다. 멤버 함수 연산자는 value_compare에서 제공 하는 함수 개체에 저장 된 `key_compare` 형식의 개체 `comp`를 사용 하 여 두 요소의 정렬 키 구성 요소를 비교 합니다.
