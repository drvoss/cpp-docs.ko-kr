...
`boolalpha` `str.`[setf](../standard-library/ios-base-class.md#setf)(`ios_base::boolalpha`)를 효과적으로 호출한 다음 *str*을 반환 합니다.
...
`dec` `str.`[setf](../standard-library/ios-base-class.md#setf)(`ios_base::dec`, `ios_base::basefield`)를 효과적으로 호출한 다음 *str*을 반환 합니다.
...
조작자는 *str*를 효과적으로 호출 합니다. [setf](../standard-library/ios-base-class.md#setf)(`ios_base::fixed`, `ios_base::floatfield`)를 선택한 다음 *str*을 반환 합니다.
...
조작자는 `str`를 효과적으로 호출 **합니다.** [setf](../standard-library/ios-base-class.md#setf)(`ios_base::hex`, `ios_base::basefield`)를 선택한 다음 *str*을 반환 합니다.
...
`noboolalpha` `str.`[unsetf](../standard-library/ios-base-class.md#unsetf)`(ios_base::boolalpha)`를 효과적으로 호출한 다음 *str*을 반환 합니다.
...
조작자는 `str.`[unsetf](../standard-library/ios-base-class.md#unsetf)`(ios_base::showpoint)`를 효과적으로 호출한 다음 *str*을 반환 합니다.
...
조작자는 `str.`[unsetf](../standard-library/ios-base-class.md#unsetf)`(ios_base::skipws)`를 효과적으로 호출한 다음 *str*을 반환 합니다.
...
조작자는 `str.`[setf](../standard-library/ios-base-class.md#setf)`(ios_base::oct, ios_base::basefield)`를 효과적으로 호출한 다음 *str*을 반환 합니다.
...
조작자는 `str.`[setf](../standard-library/ios-base-class.md#setf)`(ios_base::right, ios_base::adjustfield)`를 효과적으로 호출한 다음 *str*을 반환 합니다.
...
조작자는 `str.`[setf](../standard-library/ios-base-class.md#setf)`(ios_base::scientific, ios_base::floatfield)`를 효과적으로 호출한 다음 *str*을 반환 합니다.
...
조작자는 `str.`[setf](../standard-library/ios-base-class.md#setf)`(ios_base::showbase)`를 효과적으로 호출한 다음 *str*을 반환 합니다.
...
조작자는 `str.`[setf](../standard-library/ios-base-class.md#setf)`(ios_base::showpoint)`를 효과적으로 호출한 다음 *str*을 반환 합니다.
...
조작자는 `str.`[setf](../standard-library/ios-base-class.md#setf)`(ios_base::showpos)`를 효과적으로 호출한 다음 *str*을 반환 합니다.
...
조작자는 `str.`[setf](../standard-library/ios-base-class.md#setf)`(ios_base::skipws)`를 효과적으로 호출한 다음 *str*을 반환 합니다.
