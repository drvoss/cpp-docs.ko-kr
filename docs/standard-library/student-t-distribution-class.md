...
클래스 템플릿은 사용자가 지정한 정수 형식의 값을 생성하는 분포를 설명하거나 학생의 *t*-Distribution에 따라 배포된 값이 제공되지 않으면 **double을** 입력합니다. 다음 테이블은 개별 멤버에 대한 문서와 연결되어 있습니다.
...
## <a name="student_t_distributionparam_type"></a><a name="param_type"></a>student_t_distribution::p아람_타입
