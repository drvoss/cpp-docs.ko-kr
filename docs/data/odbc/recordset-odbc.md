...
- `CRecordset::forwardOnly` 옵션을 *열기* 멤버 함수의 [nOpenType](../../mfc/reference/crecordset-class.md#open) 매개 변수로 전달합니다.

- `CRecordset::readOnly`의 *dwOptions* 매개 변수에 `Open`를 지정합니다.
