...
## <a name="iot-predefined-build-configurations"></a>IoT 미리 정의된 빌드 구성
...
## <a name="mingw-predefined-build-configurations"></a>MinGW 미리 정의된 빌드 구성
...
## <a name="x86-64-predefined-build-configurations"></a>x86-64 미리 정의된 빌드 구성
