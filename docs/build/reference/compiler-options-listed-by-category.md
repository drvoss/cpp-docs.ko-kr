...
|[/Qpar-report](qpar-report-auto-parallelizer-reporting-level.md)|자동 병렬화 보고 수준을 사용하도록 설정합니다.|
...
|[/V](v-version-number.md)|사용되지 않음. *`.obj`* 파일 버전 문자열을 설정 합니다.|
