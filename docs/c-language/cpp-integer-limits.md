...
|**LLONG_MIN**|**long long** 형식 변수의 최솟값입니다.|-9,223,372,036,854,775,807 - 1|
|**LLONG_MAX**|**long long** 형식 변수의 최댓값입니다.|9,223,372,036,854,775,807|
|**ULLONG_MAX**|**unsigned long long** 형식 변수의 최댓값입니다.|18,446,744,073,709,551,615 (0xffffffffffffffff)|
