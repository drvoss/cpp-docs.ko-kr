...
Microsoft 확장을 사용할 수 있을 때 함수 정의가 동일한 소스 파일에 있는 경우 및 정의가 명시적으로 **static** 스토리지 클래스를 지정하는 경우 원래 스토리지 클래스를 사용하지 않거나 `extern` 스토리지 클래스를 사용하여 선언된 함수에 **static** 스토리지 클래스가 지정됩니다.
