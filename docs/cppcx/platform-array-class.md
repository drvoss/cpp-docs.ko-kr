...
Platform:: Array는 platform:: [WriteOnlyArray 클래스](../cppcx/platform-writeonlyarray-class.md) 의 모든 메서드를 상속 하 고 [Platform:: Iboxarray 인터페이스](../cppcx/platform-iboxarray-interface.md)의 `Value` 속성을 구현 합니다.
...
*index*<br/>
배열에서 요소를 식별하는 0부터 시작하는 인덱스를 확인합니다. 최소 인덱스는 0이 고, 최대 인덱스는 [배열 생성자](#ctor)의 `size` 매개 변수에 지정 된 값입니다.
