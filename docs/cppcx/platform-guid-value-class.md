...
새 `Platform::Guid`를 생성 하려면 [Windows::기초::GuidHelp::CreateNewGuid](/uwp/api/windows.foundation.guidhelper.createnewguid#Windows_Foundation_GuidHelper_CreateNewGuid) 정적 메서드를 사용 합니다.
