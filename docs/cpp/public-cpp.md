...
클래스 멤버 목록 앞에 오는 **public** 키워드는 모든 함수에서 해당 멤버에 액세스할 수 있도록 지정 합니다. 이 설정은 다음 액세스 지정자 또는 클래스 끝까지 선언된 모든 멤버에 적용됩니다.

기본 클래스의 이름 앞에 오는 **public** 키워드는 기본 클래스의 공용 및 보호 된 멤버가 각각 파생 클래스의 public 및 protected 멤버 임을 지정 합니다.
