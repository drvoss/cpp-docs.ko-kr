...
클래스 멤버 목록 앞에 **private** 키워드를 지정 하면 해당 멤버는 클래스의 멤버 함수 및 friend 에서만 액세스할 수 있습니다. 이 설정은 다음 액세스 지정자 또는 클래스 끝까지 선언된 모든 멤버에 적용됩니다.

기본 클래스의 이름 앞에 **private** 키워드는 기본 클래스의 공용 및 보호 된 멤버가 파생 클래스의 private 멤버 임을 지정 합니다.
