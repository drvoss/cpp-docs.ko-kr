...
- [방법: CLR 콘솔 애플리케이션 만들기(C++/CLI)](../dotnet/how-to-create-clr-console-applications-cpp-cli.md)
...
- [방법: 클래스 및 구조체 정의 및 사용(C++/CLI)](../dotnet/how-to-define-and-consume-classes-and-structs-cpp-cli.md)
