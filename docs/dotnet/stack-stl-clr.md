...
|[stack::generic_value(STL/CLR)](#generic_value)|컨테이너 어댑터의 제네릭 인터페이스에 대 한 요소의 형식입니다.|
...
|[stack::to_array(STL/CLR)](#to_array)|제어 되는 시퀀스를 새 배열에 복사 합니다.|
...
래핑된 컨테이너로 *래핑된* 기존 컨테이너를 사용 합니다. 이를 사용 하 여 기존 컨테이너에서 스택을 생성 합니다.
