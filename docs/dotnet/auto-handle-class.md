...
|[auto_handle::release](#release)|`auto_handle` management에서 개체를 해제 합니다.|
|[auto_handle::reset](#reset)|현재 소유 하 고 있는 개체를 삭제 하 고 필요에 따라 새 개체를 소유 합니다.|
|[auto_handle::swap](#swap)|개체를 다른 `auto_handle`바꿉니다.|  
...
|[auto_handle::operator auto_handle](#operator-auto-handle)|`auto_handle` 형식과 호환 되는 형식 사이의 형식 캐스팅 연산자입니다.|  
|[auto_handle::operator bool](#operator-bool)|조건식에 `auto_handle`을 사용 하기 위한 연산자입니다.|
|[auto_handle::operator!](#operator-logical-not)|조건식에 `auto_handle`을 사용 하기 위한 연산자입니다.|  
...
`auto_handle` management에서 개체를 해제 합니다.
...
*_right*<br/>
현재 `auto_handle`에 할당할 `auto_handle`입니다.

### <a name="return-value"></a>반환 값

현재 `auto_handle`이제 `_right`소유 합니다.
...
`auto_handle` 형식과 호환 되는 형식 사이의 형식 캐스팅 연산자입니다.
...
현재 `auto_handle` `auto_handle<_other_type>`으로 캐스팅 됩니다.
...
조건식에 `auto_handle`을 사용 하기 위한 연산자입니다.
