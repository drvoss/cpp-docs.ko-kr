...
ms.locfileid: "77126190"
---
# <a name="unorm_3-class"></a>unorm_3 클래스

세 개의 부호 없는 일반 숫자의 짧은 벡터를 나타냅니다.
...
|name|설명|
|----------|-----------------|
|[unorm_3 생성자](#ctor)|오버로드됨. 기본 생성자는 0으로 모든 요소를 초기화 합니다.|
