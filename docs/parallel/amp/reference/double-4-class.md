...
ms.locfileid: "77139349"
---
# <a name="double_4-class"></a>double_4 클래스

네 double의 짧은 벡터를 나타냅니다.
...
|속성|Description|
|----------|-----------------|
|[double_4 생성자](#ctor)|오버로드되었습니다. 기본 생성자는 0으로 모든 요소를 초기화 합니다.|
