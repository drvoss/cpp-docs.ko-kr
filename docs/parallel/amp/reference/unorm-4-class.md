...
ms.locfileid: "77142943"
---
# <a name="unorm_4-class"></a>unorm_4 클래스

부호 없는 네 가지 일반 숫자의 짧은 벡터를 나타냅니다.
...
|name|설명|
|----------|-----------------|
|[unorm_4 생성자](#ctor)|오버로드됨. 기본 생성자는 0으로 모든 요소를 초기화 합니다.|
