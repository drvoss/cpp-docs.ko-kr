...
> [!IMPORTANT]
> 작업 스케줄러는 UWP (유니버설 Windows 플랫폼) 앱에서 사용할 수 없습니다. 자세한 내용은 [UWP 앱에 대 한에서 C++ 비동기 작업 만들기](../../parallel/concrt/creating-asynchronous-operations-in-cpp-for-windows-store-apps.md)를 참조 하세요.
>
...
|[다른 동시성 모델과 비교](../../parallel/concrt/comparing-the-concurrency-runtime-to-other-concurrency-models.md)|우선 및 협조적 일정 예약 메커니즘 간의 차이점을 설명합니다.|
