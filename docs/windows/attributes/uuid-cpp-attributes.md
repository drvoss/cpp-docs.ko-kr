...
ATL을 사용 하지 않는 프로젝트에서 사용 하는 경우 **uuid** 특성을 지정 하는 것은 [uuid](../../cpp/uuid-cpp.md) **__declspec** 한정자를 지정 하는 것과 같습니다. 클래스의 **uuid** 를 검색 하려면 [__uuidof](../../cpp/uuidof-operator.md) 를 사용할 수 있습니다.
