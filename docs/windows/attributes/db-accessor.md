...
ms.locfileid: "80214866"
---
# <a name="db_accessor"></a>db_accessor

`IAccessor`기반 바인딩에 참여 하는 `db_column` 특성을 그룹화 합니다.
...
**db_accessor** 는 동일한 클래스 또는 함수 내의 후속 `db_column` 및 `db_param` 특성에 대 한 기본 OLE DB 접근자를 정의 합니다. **db_accessor** 은 멤버 수준에서 사용할 수 있으며 OLE DB `IAccessor`기반 바인딩에 참여 하는 `db_column` 특성을 그룹화 하는 데 사용 됩니다. `db_table` 또는 `db_command` 특성과 함께 사용 됩니다. 이 특성을 호출 하는 것은 [BEGIN_ACCESSOR](../../data/oledb/begin-accessor.md) 및 [END_ACCESSOR](../../data/oledb/end-accessor.md) 매크로를 호출 하는 것과 비슷합니다.
