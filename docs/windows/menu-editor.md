...
1. 메뉴 **뷰로** 이동 하 여 **다른 창** > **리소스 뷰** > **메뉴** 제목을 마우스 오른쪽 단추로 클릭 합니다. **리소스 추가**를 선택 하 고 **메뉴**를 선택 합니다.
...
- 예를 들어 팝업 메뉴를 응용 프로그램에 연결 하려면 WM_CONTEXTMENU 메시지 처리기를 추가한 후 메시지 처리기에 다음 코드를 추가 합니다.
